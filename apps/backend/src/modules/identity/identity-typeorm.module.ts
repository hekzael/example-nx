...
import { TypeormPermissionRepositoryAdapter } from './infrastructure/persistence/typeorm/typeorm-permission-repository.adapter';
import { TypeormRoleRepositoryAdapter } from './infrastructure/persistence/typeorm/typeorm-role-repository.adapter';
import { TypeormUserRepositoryAdapter } from './infrastructure/persistence/typeorm/typeorm-user-repository.adapter';
import { TypeormPermissionEntity } from './infrastructure/persistence/typeorm/entities/typeorm-permission.entity';
import { TypeormRoleEntity } from './infrastructure/persistence/typeorm/entities/typeorm-role.entity';
import { TypeormUserEntity } from './infrastructure/persistence/typeorm/entities/typeorm-user.entity';
import { TypeormRolePermissionEntity } from './infrastructure/persistence/typeorm/entities/typeorm-role-permission.entity';
import { TypeormUserPermissionEntity } from './infrastructure/persistence/typeorm/entities/typeorm-user-permission.entity';
import { TypeormUserRoleEntity } from './infrastructure/persistence/typeorm/entities/typeorm-user-role.entity';
import { TypeormProjectToolEntity } from './infrastructure/persistence/typeorm/entities/typeorm-project-tool.entity';
import { TypeormToolAvailabilityAdapter } from './infrastructure/security/typeorm/typeorm-tool-availability.adapter';
  ...
  providers: [
    ...
    { provide: IDENTITY_TOKENS.EMAIL_VERIFICATION_TOKEN, useClass: InMemoryEmailVerificationTokenAdapter },
    {
      ...
      useFactory: (
        ...
        userRoleRepository: Repository<TypeormUserRoleEntity>,
        userPermissionRepository: Repository<TypeormUserPermissionEntity>,
      ) =>
        new TypeormUserRepositoryAdapter(
          userRepository,
          userRoleRepository,
      ...
      inject: [
        ...
        getRepositoryToken(TypeormUserRoleEntity),
        getRepositoryToken(TypeormUserPermissionEntity),
      ],
    },
    {
      provide: IDENTITY_TOKENS.ROLE_REPOSITORY,
      useFactory: (
        roleRepository: Repository<TypeormRoleEntity>,
        rolePermissionRepository: Repository<TypeormRolePermissionEntity>,
      ) =>
        new TypeormRoleRepositoryAdapter(roleRepository, rolePermissionRepository),
      inject: [
        getRepositoryToken(TypeormRoleEntity),
        getRepositoryToken(TypeormRolePermissionEntity),
      ],
    },
    {
      provide: IDENTITY_TOKENS.PERMISSION_REPOSITORY,
      useFactory: (permissionRepository: Repository<TypeormPermissionEntity>) =>
        new TypeormPermissionRepositoryAdapter(permissionRepository),
      inject: [getRepositoryToken(TypeormPermissionEntity)],
    },
    {
      provide: IDENTITY_TOKENS.TOOL_AVAILABILITY,
      useFactory: (projectToolRepository: Repository<TypeormProjectToolEntity>) =>
        new TypeormToolAvailabilityAdapter(projectToolRepository),
      inject: [getRepositoryToken(TypeormProjectToolEntity)],
    },
    {
