...
- Proyecto y Equipo (Proyectos, M�dulos, Equipos, Ambiente de operaci�n)
- Operaci�n de Herramientas (Herramientas, Solicitudes, Aprobaci�nes, Ejecuci�nes)
- Auditor�a (Eventos)

## Context Map

Identidad y Acceso provee autorizaci�n al resto. Proyectos y Equipos define el alcance operativo. Operaci�n de Herramientas consume ambos y publica eventos de Auditor�a.

## Entidades

- **Usuario**: Persona con acceso (email, display_name).
- **Proyecto**: Agrupa módulos, entornos y equipos.
- **Módulo**: Unidad funcional dentro de un proyecto.
- **Entorno**: Instancia de despliegue configurada por proyecto (dev, prod).
- **Equipo**: Grupo de usuarios asignados a módulos.
- **Solicitud**: Petición de ejecución de herramienta.

## Entidades (Deprecated)

- Proyecto: agrupa m�dulos y equipos asignados.
- Equipo: usuarios con roles en un proyecto.
- Solicitud: estado y datos de la accion solicitada.

## Value Objects

- AmbienteOperaci�nTipo (dev, demo, staging, prod)
...
- Proyecto (root).
- Equipo (root).
- Solicitud (root) con Aprobaci�nes y Ejecuci�nes.
...
- Proyecto 1..\* AmbientesOperaci�n
- Proyecto 0..\* Herramientas habilitadas
- Solicitud 1..1 Proyecto
- Solicitud 1..1 Herramienta
- Solicitud 1..1 AmbienteOperaci�n
- Solicitud 0..1 Modulo
- Solicitud 0..\* Aprobaci�nes
- Solicitud 0..\* Ejecuci�nes
...
- Un Usuario solo puede solicitar sobre proyectos/m�dulos a los que su equipo este asignado.
- Una Solicitud solo puede ejecutarse si fue aprobada segun sus reglas.
- Aprobaci�n minima: 1, configurable a 2 o 3.
- Se puede requerir aprobaci�n de un rol especifico, configurable por entorno.
- Las reglas de aprobaci�n (minimo y rol requerido) son configurables por entorno/proyecto.
- Toda Ejecuci�n debe generar un evento de Auditor�a.
...
- Email cambio requiere verificaci�n.
